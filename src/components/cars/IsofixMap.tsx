  ...
  return (
    <div className="bg-[#0e1424]/80 backdrop-blur-xl border border-white/[0.08] rounded-2xl p-5 sm:p-6 shadow-xl text-slate-200">
      <div className="pb-4 border-b border-white/[0.06] flex items-center justify-between">
        ...
        <span className="px-3 py-1 rounded-full bg-slate-800 text-cyan-400 border border-cyan-500/30 text-xs font-bold">
          {safety.ncapRating}
        </span>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-6">
        ...
        <div className="p-4 rounded-xl bg-slate-900/50/70 border border-slate-800">
