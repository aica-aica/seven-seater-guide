  ...
  return (
    <div className="bg-slate-900 border border-slate-800 rounded-2xl p-5 sm:p-6 shadow-xl text-slate-200">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 my-6">
        <div className="p-4 rounded-xl bg-slate-950/80 border border-amber-500/40 relative overflow-hidden">
          <div className="absolute -top-1 -right-1 bg-amber-500 text-slate-950 font-black text-[9px] px-2 py-0.5 rounded-bl">
            7人滿載模式
          </div>
